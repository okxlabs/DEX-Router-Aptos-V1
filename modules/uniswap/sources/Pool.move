...
module uniswapv2::pool {
    ...
    use uniswapv2::uniswap_math as math;
    // use MetaxTradeUtils::math2 as math;
    ...
    public entry fun aggregator_swap<CoinType1, CoinType2>(
        x_in: Coin<CoinType1> 
    ): ( Coin<CoinType2> ) acquires PoolData {
        let amountIn = coin::value(&x_in);
        ...
        coin::merge(&mut pool_store.reserves.r0, x_in);
